...
for file in files:
    ...
    # Yang provided the character matrix as per tumors. For all tumor values, read the character matrix.
    for value in unique_tumor_values:
        tumor_character_matrix = []
        tumor_character_matrix_cellspecific = []

        # some character matrixes contain cell combining specific tumors and they are named as "All_character_matrix"
